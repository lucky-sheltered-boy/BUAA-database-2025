...
-- 注意：初始已选人数设为0，由后续插入选课记录时的触发器自动更新
INSERT INTO `开课实例表` (`课程ID`, `教室ID`, `学期ID`, `对内名额`, `对外名额`, `已选对内人数`, `已选对外人数`) VALUES
-- 计算机学院课程
('CS101', 1, 4, 50, 10, 0, 0),    -- 数据结构 [教室1:60容量] 周一1-2,周三1-2
('CS102', 2, 4, 70, 10, 0, 0),    -- 计算机组成原理 [教室2:80容量] 周二1-2,周四3-4
('CS103', 3, 4, 50, 10, 0, 0),    -- 操作系统 [教室3:60容量] 周一3-4,周三5
('CS201', 4, 4, 90, 10, 0, 0),    -- 计算机网络 [教室4:100容量] 周二3-4,周四1-2
-- 软件学院课程
('SE101', 5, 4, 40, 10, 0, 0),    -- 软件工程 [教室5:50容量] 周一5,周三3-4
('SE102', 6, 4, 40, 10, 0, 0),    -- 数据库系统 [教室6:50容量] 周二1-2,周四3-4
('SE103', 8, 4, 30, 10, 0, 0),    -- 软件测试 [教室8:40容量] 周三1-2
('SE201', 9, 4, 30, 10, 0, 0),    -- Web开发 [教室9:40容量] 周四1-2,周五3-4
-- 信息安全学院课程
('IS101', 11, 4, 25, 5, 0, 0),    -- 密码学 [教室11:30容量] 周二3-4,周四1-2
('IS102', 10, 4, 50, 10, 0, 0),   -- 网络安全 [教室10:60容量] 周一1-2,周三3-4
-- 数学学院课程
('MATH101', 7, 4, 100, 20, 0, 0), -- 高等数学A [教室7:120容量] 周二1-2,周四3-4,周五1-2 (修改避免与网络安全冲突)
('MATH102', 3, 4, 50, 10, 0, 0),  -- 线性代数 [改教室3:60容量] 周三3-4,周五3-4 (修改避免与密码学教师冲突)
-- 物理学院课程
('PHY102', 12, 4, 25, 5, 0, 0);   -- 大学物理实验 [教室12:30容量] 周四3-4
