...
if (Test-Path "frontend") {
    ...
    Write-Host "已进入 frontend 目录" -ForegroundColor Green
    Write-Host "当前路径: $(Get-Location)" -ForegroundColor Gray
} else {
    Write-Host "frontend 目录不存在！" -ForegroundColor Red
    exit 1
}
...
if (Test-Path "node_modules") {
    Write-Host "检测到已有 node_modules 目录，跳过安装..." -ForegroundColor Yellow
    Write-Host ""
    Write-Host "========================================" -ForegroundColor Cyan
    ...
    Write-Host "  教师: T1001 / 123456" -ForegroundColor White
